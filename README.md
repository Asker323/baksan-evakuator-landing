...
В рамках проекта разработан высококонтрастный макет рекламного плаката (автомобильного винила) на кузов эвакуатора для привлечения клиентов с трассы и офлайн-точек.

<p align="center">
  <img src="tow-truck-car-wrap-design.png" alt="Tow Truck Car Wrap Design" width="450">
</p>

### 🛠️ Спецификации и дизайн-решения:
- **Векторный исходник для печати:** [tow-truck-car-wrap-design.pdf](tow-truck-car-wrap-design.pdf) (масштабируется под любые габариты кабины без потери чёткости).
- **Сквозной брендинг:** Цветовая схема (сигнальный черный и ярко-желтый `#FFCC00`) полностью унаследована от интерфейса разработанного лендинга.
- **Интерактивная интеграция:** В макет интегрирован адаптивный QR-код. Когда спецтехника находится на стоянке, парковке или месте ДТП, пешеходы и водители могут мгновенно отсканировать код и перейти на сайт для заказа.
- **Повышенная читаемость:** Использование массивного гротеска и акцентных блоков для ключевых УТП (*«МЕЖГОРОД • ПО ВСЕЙ РОССИИ»*), считываемых в движении за 2-3 секунды.
